(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ttUtils"] = factory();
	else
		root["ttUtils"] = factory();
})(this, function() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__formatTime__ = __webpack_require__(7);


/* harmony default export */ __webpack_exports__["default"] = ({ formatTime: __WEBPACK_IMPORTED_MODULE_0__formatTime__["a" /* default */] });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_nan__ = __webpack_require__(8);
...
var formatTime = function formatTime(value, format) {
    ...
    if (__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_nan___default()(+value)) return value;

    var date = new Date(value);
    // Can't parse to a invalid Date object. for example => new Date(149077400686412312313)
    if (__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_nan___default()(date.getTime())) {
        return value;
    }
